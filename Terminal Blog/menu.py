...
class Menu():
    def __init__(self):
        ...
        self.user_blog = None
        #check if they've already got an acount
        if self._user_has_account():  #underscore in font of the method makes it private
    ...
    def run_menu(self):
        read_or_write = input("Do you want to read(R) or write(W) our blog?")
